...
<table border='1'>
    <%
        ...
        while (headers.hasMoreElements()) {
            ...
            out.println("<tr><td>" + header + "</td><td>" + HtmlUtils.htmlEscape(request.getHeader(header)) + "</td></tr>");
        }
...
<%
    ...
    if (null != cookies) {
        for (Cookie cookie : cookies) {
            out.println("<tr><td>" + cookie.getName() + "</td><td>" + HtmlUtils.htmlEscape(cookie.getValue()) + "</td></tr>");
        }
    }
    out.println("</table>");
%>
...
<table border="1">
    ...
    <tr>
        ...
        <td><%=HtmlUtils.htmlEscape(request.getParameter(parameter))%>
        </td>
...
<table border="1">
    ...
    <%
        for (Map.Entry<Object, Object> entry : System.getProperties().entrySet()) {
            ...
            if (propertyName.indexOf("java.library.path") >= 0 || propertyName.indexOf("ws.ext.dirs") >= 0
                ...
                out.println("</pre>");
            } else if (propertyName.toLowerCase().indexOf("password") >= 0 || propertyName.toLowerCase().indexOf("key") >= 0) {
                out.println("***");
            } else {
    ...
    <tr>
        ...
        <td><%=new java.io.File(".").getCanonicalPath()%>
        </td>
    </tr>
